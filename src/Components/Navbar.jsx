...
export const Navbar = () => {
  const resume = () => {
    window.open(
      "https://drive.google.com/file/d/1Hclk8cYVIVGCHnz0NTwELLlvoaSXhbJm/view",
      "_blank"
    );
  };
  const [showMediaIcons, setShowMediaIcons] = useState(false);
  ...
  return (
    <>
      <nav className={`main-nav ${showMediaIcons ? "mobile-menu" : ""}`}>
        <div className="logo">
          <h2>
            <span>S</span>wati
            <span>K</span>aithwas
        ...
        <div className="resume">
          <ul className="resume-desktop">
            <li>
              <button className="homeBtns" onClick={() => resume()}>
                View Resume
              </button>
            </li>
          </ul>
